...
<html lang="en">
<head>
    <title>smartBizz - @yield('title')</title>
	
    <meta charset="utf-8" />
	{{-- Informacion para el posicionamiento en el buscador --}}
    ...
    {{-- END Informacion para el posicionamiento en el buscador --}}
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link" href="{{ route('control-usuarios-vista')}}">
                ...
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <!--end::Toolbar-->
                        <!--begin::Content-->
                        <div id="app_general" class="app-content flex-column-fluid">
